...
syn match bladeConditional /@\(choice\|each\|elseif\|extends\|for\|foreach\|forelse\|if\|include\|lang\|section\|unless\|while\|yield\)\>\s*/ nextgroup=bladeParenBlock containedin=ALLBUT,bladeComment

syn match bladeKeyword /@\(else\|empty\|endfor\|endforeach\|endforelse\|endif\|endsection\|endunless\|endwhile\|overwrite\|parent\|show\|stop\)\>/ containedin=ALL,bladeComment
